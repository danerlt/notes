...
.aside-link.aside-active, .aside-link.aside-active:hover {
  color: var(--rp-c-link);
...
.sticky_ddfa7 + section .rspress-sidebar-menu-container {
  margin-top: calc(var(--rp-nav-height) * -1);
  padding-top: var(--rp-nav-height);
}

.sticky_ddfa7 + section .rspress-local-toc-container {
  margin-top: var(--rp-nav-height);
}

.leftNav_e6722, .rightNav_a2fea {
  display: none;
}
...
.activeItem_a28b5, .singleItem_c1154:hover {
  background-color: var(--rp-c-bg-mute);
  cursor: pointer;
  color: var(--rp-c-link);
...
@media (width >= 960px) and (width <= 1280px) {
  .rspress-sidebar-menu > button:first-child, .rspress-sidebar-menu-container.no-toc {
    display: none;
  }
...
.aside-container_bc5fa {
  ...
  padding-top: calc(var(--rp-nav-height)  + var(--rp-content-padding-y));
...
.content_ff766 .rspress-doc {
  padding-bottom: 0;
}

.content_ff766 .rspress-doc-footer {
  padding-top: 0;
}
...
html {
  -webkit-text-size-adjust: 100%;
  scroll-padding-top: calc(var(--rp-nav-height)  + var(--rp-sidebar-menu-height));
  font-size: 16px;
  line-height: 1.7;
}
...
.rspress-doc :not(:where(.rp-not-doc *)):where(ul) {
  margin-top: 1rem;
  margin-bottom: 1rem;
  padding-left: 1.25rem;
  line-height: 1.75rem;
...
.rspress-doc :not(:where(.rp-not-doc *)):where(ol) {
  margin-top: 1rem;
  margin-bottom: 1rem;
  padding-left: 1.25rem;
  line-height: 1.75rem;
...
.rspress-doc :not(:where(.rp-not-doc *)):where(ul li):not(:first-child), .rspress-doc :not(:where(.rp-not-doc *)):where(ol li):not(:first-child) {
  margin-top: .5rem;
}

.rspress-doc :not(:where(.rp-not-doc *)):where(table) {
  border-collapse: collapse;
...
.rspress-doc :not(:where(.rp-not-doc *)):where(table tr) {
  border: 1px solid;
  border-color: var(--rp-c-gray-light-3);
...
.rspress-doc :not(:where(.rp-not-doc *)):where(table tr):nth-child(2n) {
  background-color: var(--rp-c-bg-soft);
}

.rspress-doc :not(:where(.rp-not-doc *)):where(table td) {
  border: 1px solid;
  border-color: var(--rp-c-gray-light-3);
  padding: .5rem 1rem;
}

.rspress-doc :not(:where(.rp-not-doc *)):where(table th) {
  color: var(--rp-c-text-1);
  border: 1px solid;
  border-color: var(--rp-c-gray-light-3);
  padding: .5rem 1rem;
...
:where(.dark) .rspress-doc :not(:where(.rp-not-doc *)):where(table), :where(.dark) .rspress-doc :not(:where(.rp-not-doc *)):where(table tr), :where(.dark) .rspress-doc :not(:where(.rp-not-doc *)):where(table td), :where(.dark) .rspress-doc :not(:where(.rp-not-doc *)):where(table th) {
  border-color: var(--rp-c-divider);
}
...
.rspress-doc h1 > code, .rspress-doc h2 > code, .rspress-doc h3 > code {
  font-size: .9em;
}
...
.rspress-doc [class^="language-"] pre, .rspress-doc [class^="language-"] code {
  text-align: left;
  white-space: pre;
  word-spacing: normal;
  word-break: normal;
...
.button_e8e0d.brand_dc619, .button_e8e0d.brand_dc619:hover, .button_e8e0d.brand_dc619:active {
  opacity: 1;
  color: #fff;
  transition: all .3s;
}
...
.button_e8e0d.alt_b0249, .button_e8e0d.alt_b0249:hover, .button_e8e0d.alt_b0249:active {
...
@media (width <= 640px) {
  .grid-2_bce10, .grid-4_bd059, .grid-6_ce438 {
    width: 100%;
  }
}
...
@media (width >= 768px) {
  .grid-2_bce10, .grid-4_bd059 {
    width: 50%;
  }

  .grid-3_bf296, .grid-6_ce438 {
    width: 33.3333%;
  }
}
...
.navHamburger_ac64c.active_bc9a1:hover .top_ea042, .navHamburger_ac64c.active_bc9a1:hover .middle_e52e2, .navHamburger_ac64c.active_bc9a1:hover .bottom_f0588 {
  transition: top .25s, background-color .25s, transform .25s;
}

.top_ea042, .middle_e52e2, .bottom_f0588 {
